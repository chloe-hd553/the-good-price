            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <button onClick={() => startCheckout("monthly")} disabled={planLoading !== null}
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <div><div style={{ fontWeight: 700, fontSize: 16, marginBottom: 2 }}>Mensuel sur 12 mois</div><div style={{ fontSize: 12, opacity: 0.7 }}>S'arrête automatiquement après 1 an</div></div>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <div style={{ textAlign: "right" }}>
                      <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 28, fontWeight: 700, color: C.yellow, lineHeight: 1 }}>9,99 €<span style={{ fontSize: 14, opacity: 0.7, marginLeft: 4 }}>/mois</span></div>
